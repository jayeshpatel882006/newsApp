...
export default class News extends Component {
  ...
  constructor() {
    ...
    async componentDidMount(){
      let url = `https://newsapi.org/v2/top-headlines?country=${this.props.contry}&category=${this.props.category}&apiKey=${this.props.apikey}&page=${this.props.page}&pagesize=${this.props.pagesize}`;
      // alert(url);
  ...
  this.setState({page: this.state.page+1})
    // alert(this.state.page);
      // const url = `https://newsapi.org/v2/top-headlines?country=${this.props.contry}&category=${this.props.category}&apiKey=1cfbe18de4d94760b8a2ddd33b2d89f6&page=2&pagesize=${this.props.pagesize}`;
         const url = `https://newsapi.org/v2/top-headlines?country=${this.props.contry}&category=${this.props.category}&apiKey=${this.props.apikey}&page=${this.state.page}&pagesize=${this.props.pagesize}`;
      // alert(url);
      this.setState({loading: true})
      let data = await fetch(url);
      let parsedata = await data.json()
